...
const Navb = styled.div`
  ...
  @media screen and (max-width: 700px) {
    ...
    animation: ${({ prop }) => (!prop ? menuOpen_animate : undefined)} 0.4s
      forwards;
    ...
    <>
      ...
      <NavBox>
        <Navb prop={state}>
          ...
          <NavLink to="/" style={NavLinkStyle} onClick={hideMenuclick}>
            Home
          </NavLink>
          <NavLink to="Services" style={NavLinkStyle} onClick={hideMenuclick}>
            Services
          </NavLink>
          <NavLink to="About" style={NavLinkStyle} onClick={hideMenuclick}>
            About
          </NavLink>
          <NavLink to="ContactUs" style={NavLinkStyle} onClick={hideMenuclick}>
            Contact{" "}
          </NavLink>
          <NavLink to="Blogs" style={NavLinkStyle} onClick={hideMenuclick}>
            Blogs
          </NavLink>
        </Navb>
      </NavBox>
